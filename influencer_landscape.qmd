...
:::
  ...
  -   [Cleaning and Processing](conversation_landscape.qmd#sec-data_cleaning): Removal of spam, unhelpful or irrelevant data, and pre-processing of text variable for embedding. However, "promotional" material is actually of interest in this project, because we are looking for influencers who will use promotional style language. Therefore care should be taken in how strict the spam removal step is.
