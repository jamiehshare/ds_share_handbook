...
Log loss measures the uncertainty of a classifier by evaluating how close predicted probabilities are to the actual labels. It penalises confident but incorrect predictions more harshly than less confident ones. It is the loss function used in logistic regression.
