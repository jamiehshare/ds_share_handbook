...
-   [X] Link to .ipynb
-   [X] Decide if I want double curly brackets or no curly brackets
...
-   [ ] How much repetition should there be in this and the template ipynb?
- [ ] Something about using MLX and MPS in teh helpful tips section
...
Once you have the authentication token, you can access the model directly from your notebook. You can sub `model_name` for the name of the model you wish to load.
...
model = AutoModelForSequenceClassification.from_pretrained("sharecreative/model_name")
```

## 2. Process and Tokenise the data
